...
class _ApplyPageState extends State<ApplyPage> {
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: kBlue.withOpacity(.3), blurRadius: 30)],
                ),
                child: const Icon(Icons.check, color: kBlue, size: 42),
              ),
              const SizedBox(height: 24),
              const Text('Application Sent!',
                  style: TextStyle(color: kTextPri, fontSize: 24, fontWeight: FontWeight.w700)),
  ...
  Widget _buildStepIndicator() {
    return Padding(
      ...
      child: Row(
        children: [
          _StepDot(number: 1, label: 'Your Info',  active: _step >= 1, done: _step > 1),
          Expanded(child: Container(height: 1, color: _step >= 2 ? kBlue : kBorder)),
          _StepDot(number: 2, label: 'Cover Note', active: _step >= 2, done: false),
        ],
      ),
    );
  }
      ...
      children: [
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(
              hintText: 'Tell the venue why you\'re the perfect fit for this gig. Mention your style, past experience, and any relevant performances…',
        ...
        _AppInput(controller: _portfolioCtrl, hint: 'https://soundcloud.com/yourname', keyboardType: TextInputType.url),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Text('← Back',
                    style: TextStyle(color: kTextSec, fontSize: 14, fontWeight: FontWeight.w600)),
              ),
            ),
...
class _AppInput extends StatelessWidget {
  ...
  const _AppInput({required this.controller, required this.hint, this.keyboardType = TextInputType.text});
        ...
        AnimatedContainer(
          ...
          child: Center(
            child: done
                ...
                : Text('$number', style: const TextStyle(color: kTextPri, fontSize: 11, fontWeight: FontWeight.w700)),
          ),
        ),
        const SizedBox(height: 4),
        Text(label,
          style: TextStyle(color: active ? kBlue : kTextMuted, fontSize: 11, fontWeight: FontWeight.w500)),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(
          child: Text(label,
            style: const TextStyle(color: kTextPri, fontSize: 15, fontWeight: FontWeight.w700, letterSpacing: .3)),
        ),
      ),
    );
  }
