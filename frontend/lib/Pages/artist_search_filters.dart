                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        final results = await ApiService.filterArtists(
                            role: _selectedRoles.isNotEmpty ? _selectedRoles.join(',') : null,
                            genre: _selectedGenres.isNotEmpty ? _selectedGenres.join(',') : null,
                            gender: _selectedGender,
                            language: _selectedLanguages.isNotEmpty ? _selectedLanguages.join(',') : null,
                            artistExp: _selectedExp,
