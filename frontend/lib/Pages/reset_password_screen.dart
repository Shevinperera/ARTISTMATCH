// ─────────────────────────────────────────────
//  reset_password_screen.dart  —  ArtistMatch
// ─────────────────────────────────────────────
import 'package:flutter/material.dart';
import 'login_page.dart';   // AMInput, AMBlueBtn
        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              const SizedBox(height: 24),
              AMInput(controller: _newCtrl, hint: 'New password', obscure: true),
              const SizedBox(height: 16),
              AMInput(controller: _confCtrl, hint: 'Confirm password', obscure: true),
              const SizedBox(height: 16),
              AMBlueBtn(
                label: 'Reset your password',
                // Pop the entire forgot-password flow back to Sign In
